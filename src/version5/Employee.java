...
public class Employee implements Cloneable {
    ...
    public void setEmpName(Name empName) { this.empName = empName == null ? new Name() : empName.clone(); }
    public void setEmpName(String empName) { this.setEmpName(Name.fromString(empName)); }
    public MyDate getBirthDate() { return this.birthDate.clone(); }
    public void setBirthDate(MyDate birthDate) { this.birthDate = birthDate == null ? new MyDate() : birthDate.clone(); }
    public MyDate getHireDate() { return this.hireDate.clone(); }
    public void setHireDate(MyDate hireDate) { this.hireDate = hireDate == null ? new MyDate() : hireDate.clone(); }

    public double getBirthdayBonus(int currentMonth) {
        return this.birthDate.getMonth() == currentMonth ? 5000.0 : 0.0;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.getClass(), this.empID, this.empName,
                this.birthDate, this.hireDate);
    }
