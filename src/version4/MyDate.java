...
public class MyDate implements Cloneable {
    ...
    private static boolean valid(int day, int month, int year) {
        ...
        int[] days = {31, leap(year) ? 29 : 28, 31, 30, 31, 30,
                31, 31, 30, 31, 30, 31};
    ...
    @Override
    public int hashCode() { return 31 * (31 * this.day + this.month) + this.year; }
    ...
    @Override
    public String toString() { return String.format("%02d/%02d/%04d", this.day, this.month, this.year); }
}
