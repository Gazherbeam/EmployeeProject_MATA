...
public class Name implements Cloneable {
    ...
    public void setFirstName(String value) {
        this.firstName = value != null && !value.trim().isEmpty() ? value.trim() : "N/A";
    }
    public String getMiddleName() { return this.middleName; }
    public void setMiddleName(String value) { this.middleName = value == null ? "" : value.trim(); }
    public String getLastName() { return this.lastName; }
    public void setLastName(String value) {
        this.lastName = value != null && !value.trim().isEmpty() ? value.trim() : "N/A";
    }
    public String getFullName() {
        String givenName = this.middleName.isEmpty()
